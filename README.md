...
From the web, you can download the packaged scripts here
    ...
    https://s3.amazonaws.com/public-airbug/bugcore-0.2.13.js
    https://s3.amazonaws.com/public-airbug/bugcore-0.2.13.min.js
...
<script type="text/javascript" src="https://s3.amazonaws.com/public-airbug/bugcore-0.2.13.min.js"></script>
```
...
<script type="text/javascript" src="https://s3.amazonaws.com/public-airbug/bugcore-0.2.13.js"></script>
...
```
[View code](https://github.com/airbug/bugcore/blob/v0.2.13/projects/bugcore/js/src/core/Class.js)
