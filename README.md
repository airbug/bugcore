...
From the web, you can download the packaged scripts here
    ...
    https://s3.amazonaws.com/public-airbug/bugcore-0.2.11.js
    https://s3.amazonaws.com/public-airbug/bugcore-0.2.11.min.js
...
<script type="text/javascript" src="https://s3.amazonaws.com/public-airbug/bugcore-0.2.11.min.js"></script>
```
...
<script type="text/javascript" src="https://s3.amazonaws.com/public-airbug/bugcore-0.2.11.js"></script>
...
```
[View code](https://github.com/airbug/bugcore/blob/v0.2.11/projects/bugcore/js/src/core/Class.js)
