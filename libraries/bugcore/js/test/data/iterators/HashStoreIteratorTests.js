...
require('bugpack').context('*', function(bugpack) {
    ...
    var hashStoreIteratorInstantiationTest = {
        ...
        test: function(test) {
            ...
            test.assertEqual(this.hashStoreIterator.getHashStoreNodeNotifyingArrayIterator(), null,
                'Assert HashStoreIterator.hashStoreNodeNotifyingArrayIterator defaults to null');
            test.assertTrue(Class.doesExtend(this.hashStoreIterator.getHashStoreNodeNotifyingObjectIterator(), NotifyingObjectIterator),
                'Assert HashStoreIterator.hashStoreNodeNotifyingObjectIterator is an ObjectIterator');
        }
    };
